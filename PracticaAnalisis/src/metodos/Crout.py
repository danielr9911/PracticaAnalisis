...
def main():
    ...
    #print(matrizA)
    #print(Ab)
    MatrizL, MatrizU, exito = Crout(matrizA,matrizB,n)
    
    if exito:
        Z = np.zeros(n)
        X = np.zeros(n)
        Z=progressiveCrout(Z,b,MatrizL,n)
        X=regressiveCrout(X,Z,MatrizU,n)
